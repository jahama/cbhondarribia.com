...
$database =& JFactory::getDBO();
  ...
  $adminDir = dirname(__FILE__);
    ...
    $database->query();
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/tournament.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=tour_list'";
    $database->setQuery($sql);
    $database->query();
  
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/players.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=player_list'";
    $database->setQuery($sql);
    $database->query();
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/positions.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=pos_list'";
    $database->setQuery($sql);
    $database->query();
  
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/matchday.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=matchday_list'";
    $database->setQuery($sql);
    $database->query();
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/events.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=event_list'";
    $database->setQuery($sql);
    $database->query();
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/teams.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=team_list'";
    $database->setQuery($sql);
    $database->query();
	
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/blleg.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=season_list'";
    $database->setQuery($sql);
    $database->query();
	
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/blleg.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=group_list'";
    $database->setQuery($sql);
    $database->query();
	
    $sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/blleg.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=fields_list'";
    $database->setQuery($sql);
    $database->query();
    $sql = "UPDATE #__components SET admin_menu_img='../includes/js/ThemeOffice/language.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=languages'";
    $database->setQuery($sql);
    $database->query();
	$sql = "UPDATE #__components SET admin_menu_img='../administrator/components/com_joomsport/img/blleg.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=moder_list'";
    $database->setQuery($sql);
    $database->query();
	
	$sql = "UPDATE #__components SET admin_menu_img='js/ThemeOffice/config.png' WHERE admin_menu_link LIKE '%option=com_joomsport&task=config'";
	$database->setQuery($sql);
	$database->query();
	...
	$database->setQuery("UPDATE #__components SET admin_menu_img='../includes/js/ThemeOffice/info.png' WHERE admin_menu_link LIKE 'option=com_joomsport&task=about'");
	$database->query();
...
/* 1.0.8 */
	...
	//stat upd
	$query = "UPDATE #__bl_match_events as me,#__bl_events as e SET me.ecount = 1 WHERE e.player_event='1' AND me.e_id=e.id AND me.ecount=0";
	$database->setQuery( $query );
	$database->query();
	//create thumbs
	ob_start();
