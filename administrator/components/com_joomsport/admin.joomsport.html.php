...
class joomsport_html
{
		...
		<table  border="0">
			...
			<tr>
				...
				<td valign="middle" width="60" align="center">
					<input type="button" value=">>" onClick="javascript:addSelectedToList('adminForm','teams_id','teams_season');" /><br />
					<input type="button" value="<<" onClick="javascript:delSelectedFromList('adminForm','teams_season');" />
				</td>
				<td >
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td align="center">
					...
					if(!$row->published){
						...
						<img border="0" alt="Unpublished" src="images/publish_x.png"/></a>
						<?php
					}else{
						?>
						<a title="Unpublish Item" onclick="return listItemTask('cb<?php echo $i?>','tour_unpubl')" href="javascript:void(0);">
						<img border="0" alt="Published" src="images/tick.png"/></a>
						<?php
					}
					?>
				</td>
	...
	function bl_editTourn($row, $lists, $option){
		...
		<table>
			<tr>
				...
				<td>
					<input type="text" maxlength="255" size="60" name="name" value="<?php echo $row->name?>" />
				</td>
			</tr>
			<tr>
				<td width="100">
			...
			<tr>
				...
				<td>
					...
					if($row->logo && is_file('../media/bearleague/'.$row->logo)){
						...
						?>
						<a href="javascript:void(0);" title="<?php echo JText::_( 'BLBE_REMOVE' ); ?>" onClick="javascript:delete_logo();"><img src="<?php echo JURI::base();?>images/publish_x.png" title="Remove" /></a>
						</div>
					<?php
					}
					?>
	...
	?>
		<table>
			<tr>
				...
				<td>
					<input type="text" maxlength="255" size="60" name="s_name" value="<?php echo $row->s_name?>" />
				</td>
			</tr>
			<tr>
				<td width="150">
		...
		<table  border="0">
			<tr>
				...
				<td valign="middle" width="60" align="center">
					<input type="button" value=">>" onClick="javascript:addSelectedToList('adminForm','usracc_id','usr_admins');" /><br />
					<input type="button" value="<<" onClick="javascript:delSelectedFromList('adminForm','usr_admins');" />
				</td>
				<td >
		...
		<?php
		echo $tabs->endPanel();
		echo $tabs->startPanel(JText::_( 'BLBE_TABLEV' ),'col_rank');
		?>
		<table>
			<tr>
		...
		<?php
		echo $tabs->endPanel();
		echo $tabs->startPanel(JText::_( 'BLBE_TTCOLOR' ),'col_conf');
		?>
		<br />
	...
	function bl_editTeam($row, $lists, $option){
		...
		<table class="adminlist">
			...
			?>
			<td align="center">
				<a href="javascript:void(0);" title="<?php echo JText::_( 'BLBE_REMOVE' ); ?>" onClick="javascript:Delete_tbl_row(this);"><img src="<?php echo JURI::base();?>images/publish_x.png" title="Remove" /></a>
			</td>
			<td align="center">
				<?php
	...
	function bl_editPos($row, $lists, $option){
		...
		<table>
			<tr>
				...
				<td>
					<input type="text" maxlength="255" size="60" name="p_name" value="<?php echo $row->p_name?>" />
				</td>
			</tr>
	...
	function bl_editPlayer($row, $lists, $option){
		...
		<table class="adminlist">
			...
			?>
			<td align="center">
				<a href="javascript:void(0);" title="<?php echo JText::_( 'BLBE_REMOVE' ); ?>" onClick="javascript:Delete_tbl_row(this);"><img src="<?php echo JURI::base();?>images/publish_x.png" title="<?php echo JText::_( 'BLBE_REMOVE' ); ?>" /></a>
			</td>
			<td align="center">
				<?php
				$ph_checked = ($row->def_img == $photos->id) ? 'checked="true"' : "";
	...
	function bl_editMday($row, $lists, $match, $s_id, $option){
		...
		function bl_add_match(){
			...
			cell1.innerHTML = '<a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="images/publish_x.png"  border="0" alt="Delete"></a>';
		...
		<table class="adminlist" id="new_matches">
			...
			if(count($match)){
				foreach($match as $curmatch){
					...
					echo "<tr>";
					echo '<td><input type="hidden" name="match_id[]" value="'.$curmatch->id.'" /><a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="images/publish_x.png"  border="0" alt="Delete"></a></td>';
...
<tr>
		...
		<table class="adminlist" id="new_events">
			...
			if(count($lists['m_events'])){
				foreach($lists['m_events'] as $m_events){
					echo "<tr>";
					echo '<td><input type="hidden" name="em_id[]" value="'.$m_events->id.'" /><a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="images/publish_x.png"  border="0" alt="Delete"></a></td>';
		...
		<table class="adminlist" id="new_tevents">
			...
			if(count($lists['t_events'])){
				foreach($lists['t_events'] as $m_events){
					echo "<tr>";
					echo '<td><a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="images/publish_x.png"  border="0" alt="Delete"></a></td>';
	...
	<div>	
		...
		<?php
		echo $tabs->endPanel();
		echo $tabs->startPanel(JText::_( 'BLBE_SQUARD' ),'squard_conf');
		?>	
	...
	function bl_editEvent($row, $lists, $option){
		...
		<table>
			<tr>
				...
				<td>
					<input type="text" name="e_name" value="<?php echo $row->e_name?>" maxlength="255" />
				</td>
			</tr>
			<tr>
	...
	function bl_editGroup($row, $lists, $option){
		...
		<table>
			<tr>
				...
				<td valign="middle" width="60" align="center">
					<input type="button" value=">>" onClick="javascript:addSelectedToList('adminForm','teams_id','teams_seasons');" /><br />
					<input type="button" value="<<" onClick="javascript:delSelectedFromList('adminForm','teams_seasons');" />
				</td>
				<td >
					<?php echo $lists['teams2'];?>
				</td>
	...
	function bl_SeasonMenu( $rows, $option )
	{
		...
		for ($i=0, $n=count( $rows ); $i < $n; $i++) {
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<a href="javascript:window.parent.jSelectArticle('<?php echo $row->id?>', '<?php echo htmlspecialchars($row->name, ENT_QUOTES, 'UTF-8')?>', 'sid');"><?php echo $row->name; ?></a>
				</td>
	...
	function bl_GroupMenu( $rows, $option )
	{
		...
		for ($i=0, $n=count( $rows ); $i < $n; $i++) {
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td>
					<a href="javascript:window.parent.jSelectArticle('<?php echo $row->id?>', '<?php echo htmlspecialchars($row->group_name, ENT_QUOTES, 'UTF-8')?>', 'gr_id');"><?php echo $row->group_name; ?></a>
				</td>
				<td>
					<?php echo $row->name; ?>
				</td>
	...
	function bl_editFields($row, $lists, $option){
		...
		<table>
			<tr>
				...
				<td>
					<input type="text" maxlength="255" size="60" name="name" value="<?php echo htmlspecialchars($row->name)?>" />
				</td>
			</tr>
			<tr>
				<td width="100">
					...
					for ($i=0, $n=count($rows); $i < $n; $i++) {
						...
						<tr class="<?php echo "row$k"; ?>">
							...
							<td><?php if ($row->is_default) { ?>
								<img src="images/tick.png"  border="0" alt="User choice" />
								<?php } ?>
							</td>
							<td></td>
						</tr>
