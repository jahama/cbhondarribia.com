...
<?php
    ...
    $mc_jg_useforresizedirection = JHTML::_('select.genericlist',$directionresize, 'jg_useforresizedirection', 'class="inputbox" size="2"', 'value', 'text', $this->_config->jg_useforresizedirection);
...
JHTML::_('joomconfig.start', 'page18');
    ...
    if($this->display_plugins_enabled):
      $showbigpic_open[] = JHTML::_('select.option', '12', JText::_('JGA_OPEN_PLUGIN'));
      $size = 6;
    else:
      $size = 5;
    endif;
