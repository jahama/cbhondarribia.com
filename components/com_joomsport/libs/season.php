...
var $db;
	...
	function getAdmLinks(){
		...
		$adm_links = '';
		$query = "SELECT s.*,t.name FROM #__users as u, #__bl_feadmins as f, #__bl_seasons as s, #__bl_tournament as t WHERE f.user_id = u.id AND s.s_id = f.season_id AND s.t_id = t.id AND u.id = ".intval($user->id);
