...
$mainframe->addCustomHeadTag( '<link href="administrator/templates/khepri/css/general.css" rel="stylesheet" type="text/css" />' ); 
...
$user	=& JFactory::getUser();
 $sid = JRequest::getVar( 'sid', 0, 'request', 'int' );
	...
	echo "<form action='index.php?option=com_joomsport&task=team_edit&controller=moder' method='post' name='chg_team'>";
