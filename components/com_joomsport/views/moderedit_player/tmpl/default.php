...
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('madmin_player');return false;"><span class="icon-32-cancel"></span><br /><?php echo JText::_('BLFA_CLOSE')?></a></div>

<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('player_save');return false;"><span class="icon-32-save"></span><br /><?php echo JText::_('BLFA_SAVE')?></a></div>
