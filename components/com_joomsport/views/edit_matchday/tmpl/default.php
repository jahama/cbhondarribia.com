...
<?php }?>
<div align="right">
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('admin_matchday');"><span class="icon-32-cancel"></span><br /><?php echo JText::_('BLFA_CLOSE')?></a></div>
<div style="float:right;padding:0px 5px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('matchday_apply');"><span class="icon-32-apply"></span><br /><?php echo JText::_('BLFA_APPLY')?></a></div>
<div style="float:right;padding:0px 5px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('matchday_save');"><span class="icon-32-save"></span><br /><?php echo JText::_('BLFA_SAVE')?></a></div>
</div>
...
<?php
		...
		<table>
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_MATCHDAYNAME' ); ?>::<?php echo JText::_( ' ' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span> 
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_ISPLAYOFF' ); ?>::<?php echo JText::_( ' ' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span> 
				</td>
				<td>
		...
		<table class="adminlist" id="new_matches" border="0">
			...
			<tr>
				...
				<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_MATCHDETAILS' ); ?>::<?php echo JText::_( 'BLFA_TT_MATCHDETAILS' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span> 
				</th>
			</tr>
			<?php
			if(count($match)){
				foreach($match as $curmatch){
					$match_link = 'index.php?option='.$option.'&amp;task=match_edit&amp;cid[]='.$curmatch->id.'&amp;controller=admin&amp;sid='.$this->s_id;
					echo "<tr>";
					echo '<td rowspan="2"><input type="hidden" name="match_id[]" value="'.$curmatch->id.'" /><a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="administrator/images/publish_x.png"  border="0" alt="Delete"></a></td>';
		...
		<table class="adminlist">
			...
			<tr>
				<th>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_HOMETEAM' ); ?>::<?php echo JText::_( '' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span> 
				</th>
				<th>
				...
				<th>	                   
					 ...
					 <span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_AWAYTEAM' ); ?>::<?php echo JText::_( '' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span> 
				</th>
			</tr>
			<tr>
				...
				<th>	
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_PLAYED' ); ?>::<?php echo JText::_( '' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span> 
				</th>
				<th>
