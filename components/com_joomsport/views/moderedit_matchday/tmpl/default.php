...
<div style="float:right;padding:0px 5px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('matchday_save');return false;"><span class="icon-32-save"></span><br /><?php echo JText::_('BLFA_SAVE')?></a></div>
		...
		<table class="adminlist" id="new_matches" border="0">
			...
			if(count($match)){
				...
				foreach($match as $curmatch){
					...
					$match_link = 'index.php?option='.$option.'&amp;task=match_medit&amp;cid[]='.$curmatch->id.'&amp;controller=moder&amp;sid='.$this->s_id.'&amp;tid='.$this->tid.'&amp;Itemid='.$Itemid;
