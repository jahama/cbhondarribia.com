...
<?php }?>
<div align="right">
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('admin_player');"><span class="icon-32-cancel"></span><br /><?php echo JText::_('BLFA_CLOSE')?></a></div>
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('player_save');"><span class="icon-32-save"></span><br /><?php echo JText::_('BLFA_SAVE')?></a></div>
</div>
		...
		<table>
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_FIRSTNAME' ); ?>::<?php echo JText::_( 'BLFA_TT_FIRST_NAME' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_LASTNAME' ); ?>::<?php echo JText::_( 'BLFA_TT_LAST_NAME' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_POSITION' ); ?>::<?php echo JText::_( 'BLFA_TT_POSITION' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
					<?php echo $lists['pos'];?>
				</td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_TEAM' ); ?>::<?php echo JText::_( 'BLFA_TT_TEAM' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_ABOUT_PLAYER' ); ?>::<?php echo JText::_( 'BLFA_TT_ABOUT_PLAYER' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
		...
		<table style="padding:10px;">
			<tr>
				<td>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_('BLFA_UPLFOTO');?>::<?php echo JText::_( 'BLFA_TT_UPLOAD_PL_PHOTO' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
			</tr>
			<tr>
				<td>&nbsp;
