...
?>
<div align="right">
<div style="float:right;padding:0px 5px;width:32px;"><a href="<?php echo JRoute::_("index.php?option=com_joomsport&controller=moder&task=matchday_medit&mid=".$row->m_id."&sid=".$s_id."&tid=".$this->tid)?>" class="toolbar" ><span class="icon-32-cancel"></span><br /><?php echo JText::_('BLFA_CLOSE')?></a></div>
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('match_apply');return false;"><span class="icon-32-apply"></span><br /><?php echo JText::_('BLFA_APPLY')?></a></div>
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('match_save');return false;"><span class="icon-32-save"></span><br /><?php echo JText::_('BLFA_SAVE')?></a></div>
</div>
