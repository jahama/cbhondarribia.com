...
?>
<div align="right">
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('admin_match');"><span class="icon-32-cancel"></span><br /><?php echo JText::_('BLFA_CLOSE')?></a></div>
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('match_apply');"><span class="icon-32-apply"></span><br /><?php echo JText::_('BLFA_APPLY')?></a></div>
<div style="float:right;padding:0px 5px;width:32px;"><a href="#" class="toolbar" onclick="javascript:submitbutton('match_save');"><span class="icon-32-save"></span><br /><?php echo JText::_('BLFA_SAVE')?></a></div>
</div>
...
<?php
		...
		function bl_add_event(){
			...
			cell1.innerHTML = '<a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="administrator/images/publish_x.png"  border="0" alt="Delete"></a>';
		...
		<table>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_RESULTS' ); ?>::<?php echo JText::_( '' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_BONUSPTS' ); ?>::<?php echo JText::_( '' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
			...
			<tr>
				<td>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_ET' ); ?>::<?php echo JText::_( '' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<Td>
			...
			<tr>
				<td>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_PLAYED' ); ?>::<?php echo JText::_( 'BLFA_TT_PLAYED' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>					
				</td>
				<Td>
			...
			<tr>
				<td>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_DATE' ); ?>::<?php echo JText::_( 'BLFA_TT_DATE' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>					
			...
			<tr>
				<td>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_TIME' ); ?>::<?php echo JText::_( 'BLFA_TT_TIME' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
			...
			<tr>
				<td>
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_LOCATION' ); ?>::<?php echo JText::_( 'BLFA_TT_LOCATION' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
			...
			<tr>
				<td width="100">
					...
					<span class="editlinktip hasTip" title="<?php echo JText::_( 'BLFA_ABOUTMATCH' ); ?>::<?php echo JText::_( '' );?>"><img src="administrator/components/com_joomsport/img/quest.jpg" border="0" /></span>
				</td>
				<td>
...
<tr>
		...
		<table class="adminlist" id="new_events">
			...
			if(count($lists['m_events'])){
				foreach($lists['m_events'] as $m_events){
					echo "<tr>";
					echo '<td><input type="hidden" name="em_id[]" value="'.$m_events->id.'" /><a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="administrator/images/publish_x.png"  border="0" alt="Delete"></a></td>';
		...
		<table class="adminlist" id="new_tevents">
			...
			if(count($lists['t_events'])){
				foreach($lists['t_events'] as $m_events){
					echo "<tr>";
					echo '<td><a href="javascript: void(0);" onClick="javascript:Delete_tbl_row(this); return false;" title="Delete"><img src="administrator/images/publish_x.png"  border="0" alt="Delete"></a></td>';
	...
	<div>	
		...
		<table class="adminlist">
			...
			?>
			<td align="center">
				<a href="javascript:void(0);" title="Remove" onClick="javascript:Delete_tbl_row(this);"><img src="<?php echo JURI::base();?>administrator/images/publish_x.png" title="Remove" /></a>
