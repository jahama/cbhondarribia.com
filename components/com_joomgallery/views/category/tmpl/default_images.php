...
<?php   for($col_count = 0; ($col_count < $column) && ($index < $count_pics); $col_count++):
    ...
    <div class="jg_element_cat">
      <a href="<?php echo $row->link; ?>" class="jg_catelem_photo">
        <img src="<?php echo $this->_ambit->getImg('thumb_url', $row); ?>" class="jg_photo" <?php echo $row->imgwh; ?> alt="<?php echo $row->imgtitle; ?>" /></a>
...
<?php     endif;
          ...
          <li>
            <?php echo JText::sprintf('JGS_COMMON_RATING_VAR', $row->ratings); ?>&nbsp;
          </li>
<?php     endif;
...
<?php     if($this->params->get('show_download_icon') || $this->params->get('show_favourites_icon') || $row->event->icons): ?>
          <li>
